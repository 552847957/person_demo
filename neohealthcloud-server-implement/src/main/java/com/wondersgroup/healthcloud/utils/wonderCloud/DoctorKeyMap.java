 ...
 */
public class DoctorKeyMap {

    private static final Logger logger = LoggerFactory.getLogger(DoctorKeyMap.class);
    private static Map<String, Map<String, String>> doctorKeyMap = Maps.newConcurrentMap();
    ...
    static {
        ...
        doctorKeyMap.put("all",doctorKeys);
    }

    public static String getPublicKey(String appVersion){
        Map<String, String> keyMap = doctorKeyMap.get(appVersion);
        if(keyMap==null){
            return doctorKeyMap.get("all").get("publicKey");
        }
    ...
    public static String getPrivateKey(String appVersion){
        Map<String, String> keyMap = doctorKeyMap.get(appVersion);
        if(keyMap==null){
            return doctorKeyMap.get("all").get("privateKey");
        }
