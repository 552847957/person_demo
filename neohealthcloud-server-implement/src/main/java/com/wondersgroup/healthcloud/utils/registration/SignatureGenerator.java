package com.wondersgroup.healthcloud.utils.registration;

import com.wondersgroup.healthcloud.registration.entity.request.BaseRequest;
...
public class SignatureGenerator {
    ...
    public static String generateSignature(BaseRequest baseRequest) {
        ...
        sign = sign + baseRequest.requestMessageHeader.getFrontproviderId();
