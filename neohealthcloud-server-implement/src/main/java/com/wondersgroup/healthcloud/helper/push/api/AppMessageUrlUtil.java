...
public class AppMessageUrlUtil {
     ...
     * @return
     */
    public static String verificationCallback(String uid, Boolean success,Boolean isChild) {
        return Type.SYSTEM.urlPrefix + "/verification?uid=" + uid + "&success=" + success +"&isChild="+isChild;
    }
