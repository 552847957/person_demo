...
public class PushClientWrapper {
    ...
    public static void main(String... args) {
        ...
        AppMessage message = AppMessage.Builder.init().title("实名认证").content("您的实名认证已经有结果了, 请点击查看").type(AppMessageUrlUtil.Type.SYSTEM).urlFragment(AppMessageUrlUtil.verificationCallback(true)).persistence(true).build();
