...
//    //DoctorUtils docUtils = DoctorUtils.getInstance(docinfoService);
//
//
...
////            DoctorEntity doctor = docUtils.getDoctor(mc.getDoctorid());
////            if(doctor==null){
////                continue;
////            }
...
////            entity.setAvatar(doctor.getHeadphoto());
...
//        String uid = AccessTokenUtils.getTokenInfo(token).getRegisterId();
//        if(!verified(uid)&&mc.getType()==2) {
//            responseEntity.setCode(1281);
//            responseEntity.setMsg("未认证医生无法查看病例");
//        }else{
//            responseEntity.setData(new MedicalCircleDetailAPIEntity(new MedicalCircleDependence(mcService, docUtils, dictCache),mc,screen_width,uid));
...
//            List<MedicalCircleReply> commentReplyList = mcService.getCommentReplyList(comment.getId(), new Date(0), "discusstime:asc", 5);
//            for (MedicalCircleReply reply : commentReplyList) {
//                CommentAPIEntity replyEntity = new CommentAPIEntity();
//                DoctorEntity replyDoctor = docUtils.getDoctor(reply.getDoctorid());
//                if(replyDoctor==null){
//                    continue;
//                }
...
//                DoctorEntity _replyDoctor = docUtils.getDoctor(reply.getReplyid());
//                if(_replyDoctor!=null) {
//                    replyEntity.setReply_name(_replyDoctor.getName() != null ? _replyDoctor.getName() : _replyDoctor.getNickname());
//                }
//                rfloor++;
...
//                CommentAPIEntity commentEntity = new CommentAPIEntity();
//                DoctorEntity commentDoctor = docUtils.getDoctor(AccessTokenUtils.getTokenInfo(token).getRegisterId());
//                if (commentDoctor != null) {
//                    commentEntity.setName(commentDoctor.getName());
//                    commentEntity.setAvatar(commentDoctor.getHeadphoto());
//                }
...
//                entity.setMsg("回复成功");
//                CommentAPIEntity replyEntity = new CommentAPIEntity();
//                DoctorEntity replyDoctor = docUtils.getDoctor(AccessTokenUtils.getTokenInfo(token).getRegisterId());
//                if (replyDoctor != null) {
//                    replyEntity.setName(replyDoctor.getName());
//                    replyEntity.setAvatar(replyDoctor.getHeadphoto());
//                }
...
//                DoctorEntity doctor = docUtils.getDoctor(reply_doctor_id);
//                if(doctor!=null) {
//                    replyEntity.setReply_name(doctor.getName() != null ? doctor.getName() : doctor.getNickname());
//                }
...
//        if(success) {
//            entity.setMsg("点赞成功");
//            DoctorEntity doctor = docUtils.getDoctor(doctor_id);
//            if(doctor!=null) {
...
//    public JsonResponseEntity<String> forward(
//            @RequestBody String body) {
//        JsonResponseEntity<String> entity = new JsonResponseEntity<>();
//        JsonKeyReader reader = new JsonKeyReader(body);
//        String doctor_id = reader.readString("doctor_id", false);
...
//        DoctorEntity d = docUtils.getDoctor(doctor_id);
//        if(d!=null) {
//            doctor.setDoctor_id(doctor_id);
//            doctor.setAvatar(d.getHeadphoto());
...
//            DoctorEntity d = docUtils.getDoctor(att.getConcernedid());
//            if(d==null){
//                continue;
//            }
//            entity.setDoctor_id(att.getConcernedid());
//            entity.setAvatar(d.getHeadphoto());
//            entity.setHospital(d.getHospitalName());
//            entity.setName(d.getName());
//            entity.setIs_attention(mcService.isAttention(uid,d.getRegisterid()));
//            list.add(entity);
//        }
//        if(attlist.size()<20){
//            more = false;
...
//        for (MedicalCircleAttention att : attlist) {
//            DoctorAPIEntity entity = new DoctorAPIEntity();
//            DoctorEntity d = docUtils.getDoctor(att.getDoctorid());
//            if(d==null){
//                continue;
//            }
...
//        }
//        //获取最后一个对象的时间作为flag
//        flag = String.valueOf(attlist.get(attlist.size() - 1) == null ? "":attlist.get(attlist.size() - 1).getAttentiontime().getTime());
//        if(attlist.size()<20){
//            more = false;
//        }
//        result.setContent(list,more,order,flag);
...
//
//
//    private Boolean verified(String doctorId){
//        DoctorEntity doctor = docUtils.getDoctor(doctorId);
//        if(doctor!=null) {
//            Boolean verified = doctor.getVerified();
//            if(verified!=null){
//                return verified;
//            }
//        }
...
//        String content = "111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111";
