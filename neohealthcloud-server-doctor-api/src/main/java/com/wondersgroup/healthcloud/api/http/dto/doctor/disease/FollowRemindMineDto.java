...
public class FollowRemindMineDto {
    ...
    public FollowRemindMineDto(Map<String, Object> map, Assessment assessment, RegisterInfo register, UserInfo userInfo) {
        ...
        if(null != map.get("report_date")){
            this.followDate = DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss").parseDateTime(map.get("report_date").toString()).toString("yyyy-MM-dd");
        }
