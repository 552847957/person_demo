...
public interface DoctorTubeSignUserRepository extends JpaRepository<DoctorTubeSignUser, String>, JpaSpecificationExecutor<DoctorTubeSignUser> {
    ...
    @Query(nativeQuery = true, value = "SELECT COUNT(*) FROM fam_doctor_tube_sign_user a, doctor_info_tb b where a.sign_doctor_personcard = b.idcard and b.del_flag = '0' AND a.sign_status = '1' AND b.id = ?1")
