...
public interface AssessmentRepository extends JpaRepository<Assessment,String> {
    ...
    @Query(nativeQuery = true, value = "select * from app_tb_patient_assessment a where a.uid = ?1 and a.is_oneself = 1 and a.del_flag=0 and a.create_date >= ?2  ORDER BY create_date desc")
