 ...
 */
public interface PushTagRepository extends JpaRepository<PushTag, Integer>,JpaSpecificationExecutor<PushTag> {

    @Query("select pt from PushTag pt where pt.tagname=?1")
    PushTag findByName(String name);

    @Query("select pt from PushTag pt where pt.tagname like ?2")
    Page findPushPag(Pageable pageable,String tagname);
}
